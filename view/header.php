				...
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
						...
						<?php if (isset($_SESSION['user_kh'])) {
							...
							<a href="index.php?act=updateuser" class="flex-c-m trans-04 p-lr-25">
								<?= $user_id ?>
							</a>
						<?php } else { ?>
						...
						<?php } ?>
						<a href="./user/logout.php" class="flex-c-m trans-04 p-lr-25">
							Logout
						</a>
					</div>
				</div>
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li class="label1" data-label1="hot">
								<a href="index.php?act=cart">Features</a>
							</li>
			...
			<div class="header-cart-content flex-w js-pscroll">
				...
				<div class="w-full">
					...
					<div class="header-cart-buttons flex-w w-full">
						<a href="index.php?act=cart" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-r-8 m-b-10">
							View Cart
						</a>

						<a href="index.php?act=cart" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-b-10">
							Check Out
						</a>
					</div>
				</div>
