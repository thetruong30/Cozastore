							...
							<?php foreach ($product_img as $pro) : ?>
								<div class="item-slick3" data-thumb="../upload/<?= $pro['product_img'] ?>">
									<div class="wrap-pic-w pos-relative">
										...
										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="../upload/<?= $pro['product_img'] ?>">
...
<section class="sec-relate-product bg0 p-t-45 p-b-105">
	<div class="container">
		...
		<?php
		$Related_Products = products_select_by_cate($product['cate_id']);
		?>
		<!-- Slide2 -->
