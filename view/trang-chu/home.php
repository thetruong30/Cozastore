			...
			<?php foreach ($categories as $category) : ?>
				<div class="col-md-6 col-lg-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						...
						<a href="index.php?act=products&cate_id=<?= $category['cate_id'] ?>" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
	...
	<div class="container">
		...
		<div class="flex-w flex-sb-m p-b-52">
			<div class="flex-w flex-l-m filter-tope-group m-tb-10">
				...
				<?php foreach ($categories as $category) : ?>
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".<?= $category['cate_name'] ?>">
						<?= $category['cate_name'] ?>
					</button>
				<?php endforeach ?>
			</div>
		...
		<div class="row isotope-grid">
			...
			<?php foreach ($products as $pro) : ?>
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item <?= $pro['cate_name'] ?>">
					<!-- Block2 -->
